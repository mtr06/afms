      ...
      {isLoading ? (
        ...
        <>
          ...
          {alert ? (
            <div
              id="toast-danger"
              class="fixed flex items-center w-4/5 md:w-full md:max-w-lg p-4 space-x-4 text-gray-500 bg-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow right-5 bottom-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800"
              role="alert"
            >
